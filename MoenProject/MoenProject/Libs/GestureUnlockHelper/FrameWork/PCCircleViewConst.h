 ...
 *  普通状态下外空心圆颜色
 */
#define CircleStateNormalOutsideColor rgba(215,221,223,1)

/**
 *  选中状态下外空心圆颜色
 */
#define CircleStateSelectedOutsideColor rgba(255,71,76,1)
 ...
 *  普通状态下内实心圆颜色
 */
#define CircleStateNormalInsideColor rgba(215,221,223,1)

/**
 *  选中状态下内实心圆颜色
 */
#define CircleStateSelectedInsideColor rgba(255,71,76,1)
 ...
 *  选中状态下三角形颜色
 */
#define CircleStateSelectedTrangleColor rgba(255,71,76,1)

/**
 *  错误状态三角形颜色
 */
#define CircleStateErrorTrangleColor rgba(255,71,76,1)
 ...
 *  普通时连线颜色
 */
#define CircleConnectLineNormalColor rgba(255,71,76,1)
 ...
 *  普通状态下文字提示的颜色
 */
#define textColorNormalState rgba(50,50,50,1)
