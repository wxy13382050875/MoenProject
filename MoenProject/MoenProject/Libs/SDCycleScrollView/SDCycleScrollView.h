...
/** 加载右滑加载更多 */
- (void)cycleScrollView:(SDCycleScrollView *)cycleScrollView offSetRightIsLaunch:(BOOL)isLaunch;
...
@property (nonatomic,assign) NSInteger myNowIndex;

/**
 越过右边界
 **/
@property (nonatomic,assign) BOOL offRightBounce;
//////////////////////  清除缓存接口  //////////////////////
