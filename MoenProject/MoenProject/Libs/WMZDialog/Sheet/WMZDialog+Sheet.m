...
- (UIView*)sheetAction{
    ...
    self.tableView.frame = CGRectMake(0, headView?
                                      ...
                                      (self.wTitle?CGRectGetMaxY(self.titleLabel.frame)+self.wMainOffsetY:0), self.wWidth, self.wCellHeight*([(NSArray*)self.wData count]>8?8:[(NSArray*)self.wData count]));
