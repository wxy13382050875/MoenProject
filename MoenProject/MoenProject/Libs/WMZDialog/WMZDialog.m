...
- (NSInteger)pickerView:(UIPickerView *)pickerView numberOfRowsInComponent:(NSInteger)component{
    return self.tree?[(NSArray*)[self getMyDataArr:component+100 withType:0] count]*(self.wPickRepeat?pickViewCount:1):[(NSArray*)self.wData[component] count]*(self.wPickRepeat?pickViewCount:1);
}
