...
- (UIView*)selectAction{
    ...
    self.tableView.frame = CGRectMake(0, CGRectGetMaxY( self.titleLabel.frame)+ (self.wTitle&&self.wTitle.length?self.wMainOffsetY:0), self.wWidth, self.wCellHeight*([(NSArray*)self.wData count]>8?8:[(NSArray*)self.wData count]));
