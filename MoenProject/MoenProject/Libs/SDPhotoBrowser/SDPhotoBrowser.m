...
- (void)setupToolbars
{
    ...
    saveButton.hidden = self.isHideSaveBtn;
...
-(void)longPress:(UILongPressGestureRecognizer *)sender{
    ...
    if (sender.state == UIGestureRecognizerStateBegan) {
        ...
        //初始化一个UIAlertController的警告框
            ...
            UIAlertAction *wx = [UIAlertAction actionWithTitle:@"保存图片到相册" style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
                NSLog(@"t提示框上的按钮 微信分享 被点击了");
                [weakSelf saveImage];
            }];
