...
+ (instancetype)colorGradientChangeWithSize:(CGSize)size
    ...
    if (direction == XWChangeDirectionDownDiagonalLine) {
    ...
    switch (direction) {
        case XWChangeDirectionHorizontal:
            endPoint = CGPointMake(1.0, 0.0);
            break;
        case XWChangeDirectionVertical:
            endPoint = CGPointMake(0.0, 1.0);
            break;
        case XWChangeDirectionUpwardDiagonalLine:
            endPoint = CGPointMake(1.0, 1.0);
            break;
        case XWChangeDirectionDownDiagonalLine:
            endPoint = CGPointMake(1.0, 0.0);
            break;
        default:
            break;
